...
for i_episode in range(1, max_episodes + 1):
    ...
    for t in range(max_timesteps):
        ...
        # Saving reward:
        memory_striker.rewards.append(reward[0])
        memory_goalie.rewards.append(reward[1])
