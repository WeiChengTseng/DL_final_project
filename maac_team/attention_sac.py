...
from maac_team.utils.misc import soft_update, hard_update, enable_gradients, disable_gradients
from maac_team.utils.agents import AttentionAgent
from maac_team.utils.critics import AttentionCritic

MSELoss = torch.nn.MSELoss()


class AttentionSACTeam(object):
    """
    ...
    def init_from_env(cls,
        ...
        agent_init_params = []
        sa_size = []
        for acsp, obsp in zip([7, 5], [112, 112]):
