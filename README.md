...
- MAAC
    ...
    - python main_maac.py --env_path ./env/linux/SoccerTwosBirdView.x86_64 --steps_per_update 9600 --episode_length 300  --buffer_length 100000 --steps_per_update 1000 --attend_heads 2
